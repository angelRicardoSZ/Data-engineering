...
#Xpath
#links = '//a[starts-with(@href, "collection") and (parent::h3|parent::h2)]'
...
class SpiderCIA(scrapy.Spider):
    ...
    def parse_link(self,response, **kwargs):
        ...
        paragraph = response.xpath('//div[@class="field-item even"]//p[not(@class) and not(child::strong)]/text()').getall()
